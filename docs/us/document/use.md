...
| `extendClass?:`     | `string or null or undefined` | `extend`                 | Start by**MINI**or**FILL**is**class** |
...
| `notFeel` | `number` | `0` | Senseless refresh (calling close without drawing loading within 300:300 milliseconds) |
